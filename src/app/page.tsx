    ...
    <main className="flex flex-col justify-center items-center gap-5">
      <section className="px-6">
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center gap-4 py-20">
          ...
          <div className="flex gap-4 mt-4">
            <Link href="/quiz">
              <button className="bg-[var(--primary)] text-white px-6 py-3 rounded-lg font-medium hover:opacity-80 transition cursor-pointer">
                Start Practicing
              </button>
            </Link>
            <Link href="/about">
      ...
      <section className="px-6 bg-[var(--muted)] py-16">
        <div className="max-w-4xl mx-auto flex flex-col gap-4 text-center">
          ...
          <p className="text-[var(--card-textColor)] leading-relaxed">
      ...
      <section className="px-6 bg-[var(--muted)] py-16 w-[70%] text-lg">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[var(--card-textColor)]">Faster improvement</p>
          </div>
          <div className="flex flex-col gap-2">
            <h3 className="text-3xl font-bold text-[var(--primary)]">100%</h3>
            <p className="text-[var(--card-textColor)]">Personalized feedback</p>
          </div>
          <div className="flex flex-col gap-2">
            <h3 className="text-3xl font-bold text-[var(--primary)]">∞</h3>
            <p className="text-[var(--card-textColor)]">Questions available</p>
          </div>
        </div>
      </section>
      <section className="px-6">
      ...
      <section className="px-6 py-20 bg-[var(--primary)] text-white rounded-lg mb-20">
        <div className="max-w-4xl mx-auto flex flex-col gap-6 text-center">
          ...
          <button className="bg-white text-[var(--primary)] px-6 py-3 rounded-lg font-medium hover:opacity-90 transition">
            Get Started
          </button>
        </div>
      </section>
